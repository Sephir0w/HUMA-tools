...
class UsdExportUI(QtWidgets.QDialog):
    ...
    def export_usd(self):
        ...
        if scene_path:
            ...
            new_path = f"HUMA/09_publish/shot/{sequenceName}/{shotName}/anim"  # Utiliser la syntaxe f-string pour insérer asset_type
            ...
            if old_path in scene_path:  # Comparaison exacte
                ...
                export_options = f"exportBlendShapes=0;exportVisibility=1;animation=1;startTime={frame_in};endTime={frame_out};mergeTransformAndShape=1;stripNamespaces=0;worldspace=0;defaultUSDFormat=usdc;"
